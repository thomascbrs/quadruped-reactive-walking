...
# Recover Logged data 
######################
file_name = "crocoddyl_eval/logs/data_2021_07_13_11_58.npz"
...
rpy = pin.rpy.matrixToRpy(pin.Quaternion(baseOrientation[k]).toRotationMatrix())
rpy[0] = 0.
rpy[1] = 0.
Rz = pin.rpy.rpyToMatrix(rpy)
l_stop = Rz.transpose() @ planner_goals[k] 
for foot in range(4):
