...
model.dt_weight_cmd = 10
model.dt_weight_bound_cmd = 10
model.stopWeights = np.ones(8)
model.forceWeights = np.ones(12)
model.shoulderContactWeight = 10
model.dt_weight_bound = 10
